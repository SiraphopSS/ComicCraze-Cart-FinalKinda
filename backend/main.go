...
func main() {
	...
	//Basket
	r.POST("/baskets/:id", controller.CreateBasket)
	r.GET("/baskets/:id/:cid", controller.GetBasket)
	r.GET("/baskets/:id", controller.ListBasket)
	r.DELETE("/baskets/:id/:cid", controller.DeleteBasket)
